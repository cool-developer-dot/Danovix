...
export const collectionPage = cn(
  "collection-page relative min-h-screen overflow-x-hidden bg-[#0c0c0c]",
);

export const collectionMain = cn("relative z-[1] w-full");
...
export const heroRoot = cn(
  "collection-hero relative flex min-h-[32vh] w-full flex-col items-center justify-center overflow-hidden",
  "bg-[#0c0c0c] pb-[clamp(2rem,5vh,3.5rem)] pt-[clamp(7.5rem,14vh,9.5rem)]",
  "sm:min-h-[36vh] lg:min-h-[38vh]",
);

export const heroStage = cn("absolute inset-0 z-0 overflow-hidden");

export const heroBg = cn("collection-hero-bg absolute inset-0");

export const heroNoise = cn("collection-hero-noise absolute inset-0");

export const heroSpotlight = cn("collection-hero-spotlight absolute");

export const heroGrain = cn("collection-hero-grain absolute inset-0");

export const heroMarble = cn("collection-hero-marble absolute inset-0");
...
export const heroWatermarkText = cn(
  ...
  "text-[clamp(4.5rem,16vw,12rem)] leading-none text-[rgb(248_247_244/0.028)]",
  "whitespace-nowrap",
);

export const heroContent = cn(
  "relative z-[2] mx-auto flex w-full max-w-[860px] flex-col items-center px-5 text-center",
  "sm:px-8",
);

export const heroEyebrow = cn(eyebrow, "mb-5 sm:mb-6");

export const heroHeadline = cn(
  "font-serif font-light leading-[1.04] tracking-[-0.028em]",
  "text-[clamp(2.35rem,6.8vw,4.15rem)] text-[rgb(248_247_244)]",
);
...
export const heroDescription = cn(
  "mt-5 max-w-[480px] text-[clamp(14px,3.2vw,16px)] leading-[1.85]",
  "text-[rgb(248_247_244/0.58)] sm:mt-6",
);

export const heroStats = cn(
  "mt-[clamp(1.75rem,5vh,2.75rem)] flex flex-wrap items-center justify-center gap-2.5",
);

export const heroStatChip = cn(
  "inline-flex items-center rounded-full border border-[rgb(248_247_244/0.12)]",
  "bg-[rgb(248_247_244/0.04)] px-4 py-2.5 backdrop-blur-[10px]",
  "font-sans text-[10px] font-medium uppercase tracking-[0.2em]",
  "text-[rgb(248_247_244/0.72)] shadow-[inset_0_1px_0_rgb(255_255_255/0.06)]",
);

/* ---------- Category navigation ---------- */

export const categoriesRoot = cn(
  "collection-categories relative z-[3] w-full",
  "px-4 sm:px-6 lg:px-10 xl:px-14",
  "pb-[clamp(1rem,3vh,1.75rem)]",
);

export const categoriesTrack = cn(
  "mx-auto flex w-full max-w-[1360px] items-center gap-2.5 overflow-x-auto pb-1",
  "[-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
  "md:flex-wrap md:justify-center md:overflow-visible",
);

export const categoryChip = cn(
  "group/cat relative inline-flex shrink-0 items-center rounded-full border px-5 py-2.5",
  "font-sans text-[10px] font-medium uppercase tracking-[0.18em]",
  "backdrop-blur-[10px] transition-[border-color,background-color,color,transform,box-shadow]",
...
export const categoryChipIdle = cn(
...
export const categoryChipActive = cn(
  "border-[rgb(198_161_91/0.55)] bg-[rgb(198_161_91/0.14)]",
  "text-[rgb(248_247_244)] shadow-[0_10px_28px_-14px_rgb(198_161_91/0.5)]",
);

/* ---------- Search ---------- */

export const searchRoot = cn(
  "collection-search relative z-40 w-full",
  "px-4 sm:px-6 lg:px-10 xl:px-14",
  "pb-[clamp(1.25rem,3.5vh,2rem)]",
  ...
  "max-md:pb-3 max-md:pt-2 max-md:backdrop-blur-md",
);

export const searchInner = cn("mx-auto w-full max-w-[920px]");
...
export const searchConsoleActive = cn(
  "-translate-y-0.5 border-[rgb(198_161_91/0.42)]",
...
export const searchIconBtn = cn(
  ...
  "text-[rgb(248_247_244/0.45)] transition-[color,transform] duration-400",
...
export const searchActionBtn = cn(
  ...
  "px-3.5 text-[rgb(248_247_244/0.55)] backdrop-blur-[8px]",
...
export const searchActionLabel = cn(
  "hidden font-sans text-[10px] font-medium uppercase tracking-[0.16em] sm:inline",
);
...
export const filtersRoot = cn(
  "collection-filters relative z-30 w-full",
  "px-4 sm:px-6 lg:px-10 xl:px-14",
...
export const filterDropdown = cn(
  ...
  "max-md:fixed max-md:inset-x-4 max-md:bottom-4 max-md:left-4 max-md:right-4",
  "max-md:top-auto max-md:min-w-0 max-md:rounded-[22px] max-md:p-3",
  "max-md:shadow-[0_-24px_64px_-12px_rgb(0_0_0/0.75)]",
);
...
export const mobileSheetScrim = cn(
  "fixed inset-0 z-30 bg-[rgb(0_0_0/0.45)] backdrop-blur-[2px] md:hidden",
);

/* ---------- Gallery ---------- */

export const galleryRoot = cn(
  "collection-gallery relative z-[2]",
  sectionInner,
  "pt-[clamp(0.5rem,2vh,1rem)] pb-[clamp(3.5rem,9vh,6rem)]",
);

export const galleryHeader = cn(
  "mb-[clamp(2rem,5vh,3.25rem)] flex flex-col items-center text-center",
);

export const galleryHeading = cn(
  "mt-4 font-serif text-[clamp(1.85rem,4.5vw,2.75rem)] font-light tracking-[-0.025em]",
  "text-[rgb(248_247_244)]",
);

export const galleryCount = cn(
  "mt-3 font-sans text-[11px] uppercase tracking-[0.22em] text-[rgb(214_196_158/0.85)]",
);

export const galleryGrid = cn(
  "grid grid-cols-2 gap-3 sm:gap-5 md:gap-6 lg:grid-cols-12 lg:gap-7",
);

export const layoutFeature = cn("col-span-2 lg:col-span-7");
export const layoutPortrait = cn("col-span-1 lg:col-span-5");
export const layoutStandard = cn("col-span-1 lg:col-span-4");
export const layoutWide = cn("col-span-2 lg:col-span-12");
export const layoutBanner = cn("col-span-2 lg:col-span-12");
export const layoutQuote = cn("col-span-2 lg:col-span-12");

/* ---------- Product card ---------- */

export const productCard = cn(
  "collection-card group/card relative flex h-full flex-col overflow-hidden",
...
export const productImageWrap = cn(
  "relative overflow-hidden rounded-[22px] m-[clamp(0.55rem,1.6vw,1rem)]",
  "border border-[rgb(248_247_244/0.1)]",
  "shadow-[0_20px_50px_-24px_rgb(0_0_0/0.7)]",
);

export const productImageFeature = cn("aspect-[4/3]");
export const productImagePortrait = cn("aspect-[3/4]");
export const productImageStandard = cn("aspect-[1/1]");
export const productImageWide = cn("aspect-[21/9] sm:aspect-[2.4/1]");

export const productImage = cn(
  "collection-card-image h-full w-full object-cover object-center",
...
export const productOverlay = cn(
  ...
  "max-md:opacity-100 max-md:bg-[linear-gradient(180deg,transparent_40%,rgb(12_12_12/0.35)_100%)]",
);

export const productSweep = cn(
  "collection-card-sweep pointer-events-none absolute inset-0 z-[3] opacity-0",
...
export const productActions = cn(
  "absolute inset-x-0 bottom-3 z-[4] flex items-center justify-center gap-2",
  "translate-y-3 opacity-0 transition-[opacity,transform] duration-500",
  "ease-[cubic-bezier(0.22,1,0.36,1)] sm:bottom-4 sm:gap-2.5",
...
export const actionButton = cn(
  "inline-flex h-10 w-10 items-center justify-center rounded-full sm:h-11 sm:w-11",
...
export const productInfo = cn(
  "flex flex-1 flex-col px-[clamp(0.9rem,2.5vw,1.5rem)] pb-[clamp(1.1rem,2.8vw,1.75rem)] pt-1",
);

export const productName = cn(
  "font-serif text-[clamp(1.05rem,2.6vw,1.55rem)] font-light tracking-[-0.015em]",
  "text-[rgb(248_247_244)]",
);

export const productSubtitle = cn(
  "mt-1.5 font-sans text-[10px] font-medium uppercase tracking-[0.18em]",
...
export const materialChip = cn(
  "inline-flex items-center rounded-full border border-[rgb(248_247_244/0.12)]",
  "bg-[rgb(248_247_244/0.04)] px-2.5 py-1",
  "font-sans text-[9px] font-medium uppercase tracking-[0.16em]",
  "text-[rgb(198_161_91/0.9)]",
);
...
export const reserveCta = cn(
  "mt-4 inline-flex min-h-10 items-center gap-2 self-start",
  "font-sans text-[10px] font-medium uppercase tracking-[0.2em]",
  "text-[rgb(248_247_244/0.72)] transition-colors duration-300",
...
export const bannerCard = cn(
  "group/banner relative flex min-h-[240px] overflow-hidden rounded-[28px] sm:min-h-[320px] lg:min-h-[380px]",
  "border border-[rgb(248_247_244/0.09)]",
  "shadow-[0_28px_70px_-28px_rgb(0_0_0/0.6)]",
);

export const bannerImage = cn(
  "object-cover transition-transform duration-[1100ms]",
  "ease-[cubic-bezier(0.22,1,0.36,1)] group-hover/banner:scale-[1.04]",
);

export const bannerOverlay = cn(
  "absolute inset-0 z-[1]",
  "bg-[linear-gradient(90deg,rgb(12_12_12/0.82)_0%,rgb(12_12_12/0.45)_48%,rgb(12_12_12/0.2)_100%)]",
  "max-md:bg-[linear-gradient(180deg,rgb(12_12_12/0.25)_0%,rgb(12_12_12/0.78)_100%)]",
);

export const bannerContent = cn(
  "absolute inset-0 z-[2] flex flex-col justify-end p-6 sm:justify-center sm:p-10 lg:p-14",
  "sm:max-w-[520px]",
);

export const bannerTitle = cn(
  "mt-3 font-serif text-[clamp(1.75rem,4vw,2.85rem)] font-light tracking-[-0.025em]",
  "text-[rgb(248_247_244)]",
);

export const bannerDescription = cn(
  "mt-3 max-w-[380px] text-[14px] leading-[1.75] text-[rgb(248_247_244/0.62)]",
);

export const bannerCta = cn(
  "mt-6 inline-flex items-center gap-2",
  "font-sans text-[10px] font-medium uppercase tracking-[0.22em]",
  "text-[rgb(248_247_244/0.88)] transition-colors duration-300",
  "hover:text-danovix-accent focus-visible:outline-none focus-visible:text-danovix-accent",
);

/* ---------- Editorial quote ---------- */

export const quoteBlock = cn(
  "relative mx-auto flex max-w-[720px] flex-col items-center px-4 py-[clamp(2.5rem,7vh,4.5rem)] text-center",
);

export const quoteText = cn(
  "font-serif text-[clamp(1.55rem,4vw,2.35rem)] font-light leading-[1.35]",
  "tracking-[-0.02em] text-[rgb(248_247_244/0.92)]",
);

export const quoteAttribution = cn(
...
export const emptyCta = cn(
  "mt-9 inline-flex min-h-12 items-center gap-3 rounded-[14px]",
...
export const storyRoot = cn(
  "collection-story relative z-[2] overflow-hidden",
  "py-[clamp(4.5rem,12vh,7.5rem)]",
);

export const storyInner = cn(
  sectionInner,
...
export const storyHeading = cn(
  "mt-5 font-serif text-[clamp(2rem,5vw,3.25rem)] font-light leading-[1.12]",
  "tracking-[-0.028em] text-[rgb(248_247_244)]",
);

export const storyBody = cn(
  "mt-6 max-w-[420px] text-[15px] leading-[1.85] text-[rgb(248_247_244/0.58)]",
);

export const storyMedia = cn(
  "relative overflow-hidden rounded-[28px] border border-[rgb(248_247_244/0.09)]",
  "aspect-[4/5] shadow-[0_32px_80px_-28px_rgb(0_0_0/0.65)] lg:col-span-7",
);

export const storyImage = cn("object-cover");

/* ---------- Featured edits ---------- */

export const featuredRoot = cn(
  "collection-featured relative z-[2]",
  sectionInner,
  "py-[clamp(3.5rem,10vh,6.5rem)]",
);

export const featuredHeader = cn("mx-auto max-w-[640px] text-center");

export const featuredHeading = cn(
  "mt-4 font-serif text-[clamp(2rem,5vw,3rem)] font-light tracking-[-0.025em]",
  "text-[rgb(248_247_244)]",
);

export const featuredGrid = cn(
  "mt-[clamp(2.5rem,7vh,4rem)] grid grid-cols-1 gap-5 md:grid-cols-3 lg:gap-7",
);

export const featuredCard = cn(
  "group/featured relative flex min-h-[340px] overflow-hidden rounded-[28px]",
  "border border-[rgb(248_247_244/0.09)] sm:min-h-[400px]",
  "shadow-[0_28px_70px_-28px_rgb(0_0_0/0.6)]",
...
export const featuredImage = cn(
  "object-cover transition-transform duration-[1100ms]",
  "ease-[cubic-bezier(0.22,1,0.36,1)] group-hover/featured:scale-[1.05]",
);

export const featuredOverlay = cn(
  "absolute inset-0 z-[1]",
  "bg-[linear-gradient(180deg,rgb(12_12_12/0.12)_0%,rgb(12_12_12/0.55)_50%,rgb(12_12_12/0.9)_100%)]",
);

export const featuredContent = cn(
  "absolute inset-x-0 bottom-0 z-[2] flex flex-col items-start p-6 sm:p-8",
);

export const featuredTitle = cn(
  "font-serif text-[clamp(1.65rem,3.5vw,2.25rem)] font-light tracking-[-0.02em]",
  "text-[rgb(248_247_244)]",
);

export const featuredSubtitle = cn(
...
export const conciergeRoot = cn(
  "collection-concierge relative z-[2] overflow-hidden",
  "bg-[#f5f2ec] py-[clamp(4.5rem,12vh,7.5rem)]",
);

export const conciergeBg = cn("collection-concierge-bg absolute inset-0");

export const conciergeNoise = cn("collection-concierge-noise absolute inset-0");

export const conciergeInner = cn(sectionInner);
...
export const continueRoot = cn(
  "collection-continue relative z-[2] overflow-hidden bg-[#0c0c0c]",
  "py-[clamp(4.5rem,12vh,7.5rem)]",
);
...
export const continueGrid = cn(
  ...
  "min-[480px]:grid-cols-2 lg:grid-cols-4 lg:gap-6",
);

export const continueCard = cn(
  "group/continue relative flex min-h-[260px] overflow-hidden rounded-[24px]",
  "border border-[rgb(248_247_244/0.09)] sm:min-h-[300px]",
...
export const continueOverlay = cn(
  "absolute inset-0 z-[1]",
  "bg-[linear-gradient(180deg,rgb(12_12_12/0.1)_0%,rgb(12_12_12/0.72)_100%)]",
);

export const continueContent = cn(
  "absolute inset-x-0 bottom-0 z-[2] p-5 sm:p-6",
);

export const continueTitle = cn(
  "font-serif text-[clamp(1.35rem,3vw,1.75rem)] font-light text-[rgb(248_247_244)]",
);

export const continueSubtitle = cn(
